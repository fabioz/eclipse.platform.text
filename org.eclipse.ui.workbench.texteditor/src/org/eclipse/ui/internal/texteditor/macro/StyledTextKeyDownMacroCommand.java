 ...
 * @since 3.11
 */
class StyledTextKeyDownMacroCommand implements IMacroCommand {

	private static final String ID = "org.eclipse.ui.texteditor.macro.styled_text_key_down_macro_command"; //$NON-NLS-1$
	...
	public StyledTextKeyDownMacroCommand(Event event) {
		this.fEvent = event;
	}
	...
	public String getUserRepresentation() {
		if (this.fEvent == null) {
			return String.format(Messages.StyledTextKeyDownMacroCommand_Key, "null"); //$NON-NLS-1$
		}
		return String.format(Messages.StyledTextKeyDownMacroCommand_Key, this.fEvent.character);
	}
	...
	/* default */ static StyledTextKeyDownMacroCommand fromMap(Map<String, String> map) {
		...
		return new StyledTextKeyDownMacroCommand(event);
	}
}